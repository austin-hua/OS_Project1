...
asmlinkage long sys_proj1_start_process(pid_t pid, struct timespec __user *p);
asmlinkage long sys_proj1_stop_process(pid_t pid, const struct timespec __user *p);
